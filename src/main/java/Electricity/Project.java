...
//        Meter Details
        ...
        m4.setIcon( new ImageIcon(image2));
        m4.setMnemonic('B');
...
//      -------------Second Column--------------
        JMenu user = new JMenu("Report");
        JMenuItem u1 = new JMenuItem("Generate Bill");
...
//      ----------Calender-------------------
        ...
        ut1.setMnemonic('C');
        ut1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_ALL_CANDIDATES, ActionEvent.CTRL_MASK));
...
//      ------------------------------------------
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if (msg.equals("Customer Details")){
            ...
            try {
                Runtime.getRuntime().exec("C:\\ProgramFiles (x86)\\Microsoft\\Edge\\Application\\msedge.exe");
            }catch (Exception e){ }
